      ...
      try {
        ...
        const normalizedProducts = items.map((product) => {
          ...
          return {
            ...
            maxPrice,
            discountPercent: 0,
            rating: product.average_rating !== undefined && product.average_rating !== null ? Number(product.average_rating) : (product.rating || 4.5),
            reviewsCount: product.total_reviews !== undefined && product.total_reviews !== null ? product.total_reviews : (product.reviewsCount || 0),
            badge: product.badge || "",
